...
class __TwigTemplate_11b2bd4214e43ba06e14ef62f03c3c865d73b1eab9b4ae52c6ce893a7791bc5c extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"content-wrapper\" style=\"min-height: 1335.69px;\">
        ...
        echo "\"class=\"btn btn-outline-primary\">Ajouter cours</a>
            </div>
        </section>
        <!-- /.content -->
    </div>
...
";
    ...
    {
        return array (  203 => 90,  184 => 73,  173 => 69,  169 => 68,  164 => 66,  160 => 65,  156 => 64,  152 => 63,  146 => 62,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"content-wrapper\" style=\"min-height: 1335.69px;\">
        ...
        <section class=\"content\">
                            ...
                            <div class=\"card-body table-responsive p-0\" style=\"height: 300px;\">
                                <table class=\"table table-striped\">
                                    ...
                                    <tr {% for g in tabcours %}>
                                        ...
                                        <td>  <a  href=\" {{ path('coursDelete', {\"id\": g.id}) }} \" onclick=\"return confirm('Êtes-vous sûr de vouloir supprimer?')\" class=\"btn btn-outline-primary\"> delete</a>
                                        <td>  <a  href=\" {{ path('updatecours', {\"id\": g.id}) }} \"  class=\"btn btn-outline-primary\"> update</a>
            ...
            <div class=\"input-group\">
                <a href=\"{{ path('addCours') }}\"class=\"btn btn-outline-primary\">Ajouter cours</a>
            </div>
        </section>
        <!-- /.content -->
    </div>

{% endblock %}", "cours/index.html.twig", "C:\\wamp64\\(2)\\www\\Fitness\\templates\\cours\\index.html.twig");
    }
}
