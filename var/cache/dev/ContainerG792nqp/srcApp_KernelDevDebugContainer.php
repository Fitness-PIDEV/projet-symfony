...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderd1edb = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer89b6d = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties39318 = [
        
    ];

    public function getConnection()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'getConnection', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'getMetadataFactory', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'getExpressionBuilder', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'beginTransaction', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'getCache', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->getCache();
    }

    public function transactional($func)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'transactional', array('func' => $func), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'wrapInTransaction', array('func' => $func), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'commit', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->commit();
    }

    public function rollback()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'rollback', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'getClassMetadata', array('className' => $className), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'createQuery', array('dql' => $dql), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'createNamedQuery', array('name' => $name), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'createQueryBuilder', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'flush', array('entity' => $entity), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'clear', array('entityName' => $entityName), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->clear($entityName);
    }

    public function close()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'close', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->close();
    }

    public function persist($entity)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'persist', array('entity' => $entity), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'remove', array('entity' => $entity), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'refresh', array('entity' => $entity), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'detach', array('entity' => $entity), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'merge', array('entity' => $entity), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'getRepository', array('entityName' => $entityName), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'contains', array('entity' => $entity), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'getEventManager', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'getConfiguration', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'isOpen', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'getUnitOfWork', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'getProxyFactory', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'initializeObject', array('obj' => $obj), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'getFilters', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'isFiltersStateClean', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'hasFilters', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return $this->valueHolderd1edb->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer89b6d = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderd1edb) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderd1edb = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderd1edb->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, '__get', ['name' => $name], $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        if (isset(self::$publicProperties39318[$name])) {
            return $this->valueHolderd1edb->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderd1edb;
    ...
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;
    ...
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, '__isset', array('name' => $name), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;
    ...
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, '__unset', array('name' => $name), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;
    ...
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, '__clone', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        $this->valueHolderd1edb = clone $this->valueHolderd1edb;
    }

    public function __sleep()
    {
        $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, '__sleep', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;

        return array('valueHolderd1edb');
    }
    ...
    {
        $this->initializer89b6d = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer89b6d;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer89b6d && ($this->initializer89b6d->__invoke($valueHolderd1edb, $this, 'initializeProxy', array(), $this->initializer89b6d) || 1) && $this->valueHolderd1edb = $valueHolderd1edb;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderd1edb;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderd1edb;
    }
}
